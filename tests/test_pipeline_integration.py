...
def test_pipeline_execution_structure(mock_web_search, mock_invoke_llm, mock_sleep):
    mock_invoke_llm.side_effect = [
        ...
        "1. Quantum computers utilize qubits.",
        "Claim 1: Accurate (Fidelity: 90%)",
        '{"status": "Verified", "confidence": 90, "snippet": "Qubits allow parallel state processing."}',
        "Quantum computing enables exponential processing speedups.",
        "Contrarian view: Error rates remain high.",
        "# Quantum Computing Overview\n\nQuantum computing is an emerging field.",
        "Score: 8.5/10\nStrengths: Clear and well-structured.",
